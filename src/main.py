...
def main():
    ...
    parser.add_argument("--cursor", type=int,
                       help="Unix microseconds timestamp to start playback from. Overrides the auto-resume cursor file (default: resume from the per-mode cursor file, e.g. data/.cursor_posts, if present)")
